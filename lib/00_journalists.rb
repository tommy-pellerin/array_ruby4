...
puts "1.Le tableau possede #{my_array.length} éléments/handles"

#Chercher la position de @epenser dans le tableau
puts "La position de @epenser dans le tableau est : #{my_array.index("@epenser")}"
...
puts "Le premier handle est : #{first_key[0]}"
puts "Le handle le plus court est : #{first_key[0]}"
